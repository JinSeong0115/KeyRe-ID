...
if __name__ == '__main__':
    import argparse
    parser = argparse.ArgumentParser(description="MARS Dataset Loader")
    parser.add_argument('--dataset_path', type=str, required=True, help='Path to the MARS dataset directory')
